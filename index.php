...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">amorkrishna90@gmail.com</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+8801986174323</li>
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">HOTEL MANAGEMENT <span>SYSTEM</span><p class="logo_w3l_agile_caption">Feel The Luxurious Life</p></a></h1>
				</div>
							...
							<!-- Modal content-->
								<div class="modal-content">
									<div class="modal-header">
										...
										<h4>Hotel  <span>Management</span></h4>
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our Hotel Management</h3>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+8801986174323</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">amorkrishna90@gmail.com</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Sankar,Dhanmondi,Dhaka,Bangladesh</p>
            ...
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3651.911641592148!2d90.36586001498138!3d23.750530084589336!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755bf4e2c05cd5b%3A0xfd49cfbf95c0c749!2sNizam+Shankar+Plaza%2C+2+Satmasjid+Road%2C+Dhaka+1207!5e0!3m2!1sen!2sbd!4v1518976486362" width="400" height="300" frameborder="0" style="border:0" allowfullscreen></iframe>
		</div>
		<div class="clearfix"></div>
	</div>
</section>
<!-- /contact -->
			<div class="copy">
		        <p>© 2017 Hotel Management . All Rights Reserved | Design by <a href="index.php">Hotel Management</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
